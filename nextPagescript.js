...
like.addEventListener('click', function () {
    ...
    localStorage.setItem('like', forlike_btn.innerHTML = liked = +1, like.classList.add('addlike'))
    localStorage.setItem('dislike', fordislike_btn.innerHTML = disliked = 0, dislike.classList.add('add_dislike'))
})
forlike_btn.innerHTML = localStorage.getItem('like', like.classList.add('addlike'))
dislike.addEventListener('click', function () {
    ...
    localStorage.setItem('like', forlike_btn.innerHTML = liked = 0, like.classList.add('addlike'))
})
fordislike_btn.innerHTML = localStorage.getItem('dislike', dislike.classList.add('add_dislike'))
